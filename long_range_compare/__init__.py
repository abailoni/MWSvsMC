...
os.path.join(get_hci_home_path(), "pyCharm_projects/GASP"),
os.path.join(get_hci_home_path(), "pyCharm_projects/speedrun"),
os.path.join(get_hci_home_path(), "pyCharm_projects/firelight"),
