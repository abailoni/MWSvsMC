...
from long_range_compare.treeMWS import TreeMWS
...
if __name__ == '__main__':
    ...
    clustering = TreeMWS(graph, edge_weights, is_edge_attractive)
    nb_iterations = -1

    final_node_labels, final_edge_labels = clustering(nb_iterations=nb_iterations)
    ...
    utils.plot_segm(ax, final_segm, z_slice=0, background=raw, highlight_boundaries=False)
    f.savefig(os.path.join(plots_path, 'tree_MWS.png'), format='png',  dpi = 300)
